// Service Worker file for development
// ...existing sw.js code from static/js/sw.js...
...
async function handleImageRequest(request) {
  try {
    ...
    // Check if the request is for a poster in /media/ or /cache/
    if (request.url.includes('/media/') || request.url.includes('/cache/')) {
      console.log('[SW] Fetching and caching poster:', request.url);
    ...
    // Otherwise, handle as a normal image
